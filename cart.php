      ...
      <?php
        ...
        <div class="page-wrapper bg-white">
            ...
            <div class="container m-t-30 bg-white">
                ...
                <img src="images/foodcart.png" width="30%" class="center"><br>
                <p class="font-serif text-xl text-gray-800 text-center">Your cart is empty</p>
                <p class="font-serif text-sm text-gray-800 text-center">You can go to home page to view more restaurants</p>
                <br>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="restaurants.php" class="bg-orange-600 text-white h-7 py-1 px-1 rounded font-bold  ">SEE RESTRURANTS NEAR YOU</a>
